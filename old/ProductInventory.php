              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    ...
                    <button class="btn btn-grayy float-end" data-bs-toggle="modal" data-bs-target="#AddInventoryModal">Add New Inventory</button>
                    <table id="dataTable" class="table table-hover mT-20 align-middle text-center" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>2011/04/25</td>
                            <td>
                              <button class="btn btn-grayy">View</button>
                            </td>
                          </tr>
                          <tr>
                            <td>PC002</td>
                            ...
                            <td>61</td>
                            <td>2011/04/25</td>
                            <td><button class="btn btn-grayy">View</button></td>
                          </tr>
                          <tr>
                            <td>PC003</td>
                            <td> <img src="https://www.healthyeating.org/images/default-source/home-0.0/nutrition-topics-2.0/general-nutrition-wellness/2-2-2-3foodgroups_fruits_detailfeature.jpg" width="50px" height="50px" alt="" srcset=""></td>
